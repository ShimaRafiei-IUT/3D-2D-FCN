...
class CropSlice(caffe.Layer):
    ...
    def reshape(self, bottom, top): 
       ...
       # top[4].reshape(1,5,sizeInput,sizeInput)#--for DFCN
    ...
    def forward(self, bottom, top):
        ...
        self.indexSlice=-1;
        while(percent[self.indexSlice]==0):
            self.indexSlice=np.random.randint(0,85)
            
        
        print "index slice=",self.indexSlice,"percent=",percent[self.indexSlice]
        ...
        print "current slice=",ss," percent =",percent[self.indexSlice]
        top[1].data[...]=bottom[1].data[:,int(ss),:,:]#--for croplabel
        top[2].data[...]=bottom[0].data[:,int(ss),:,:]#--for CurSlice
        top[3].data[...]=bottom[3].data[:,int(ss),:,:]#for weight
